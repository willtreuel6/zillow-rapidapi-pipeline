...
#Define S3 bucket
s3_bucket = 'cleaned-zillow-data-csv-bucket'
...
with DAG("zillow_analytics_dag",
        ...
        extract_zillow_data_var = PythonOperator(
            ...
            op_kwargs={
                ...
                'querystring': {"location":"atlantic beach, fl"}, 
        ...
        load_to_s3 = BashOperator(
            ...
            bash_command = 'aws s3 mv {{ ti.xcom_pull("tsk_extract_zillow_data_var")[0]}} s3://zillow-fastapi-bucket/',
        )
